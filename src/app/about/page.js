    ...
    <main className="flex min-h-screen flex-col bg-[#FFFBFA]">
      ...
      <div className="container mt-36 mx-auto py-4 px-12">
        <div className="grid grid-cols-1 lg:grid-cols-12">
          <div className="col-span-7 pb-8 place-self-left">
            ...
            <p className="text-[#574F4A] pb-4 leading-relaxed">
              I’m Melanie, a fresh graduate from the National University of
              Singapore. I majored in Communications and New Media and focused my studies on{" "}
              <b>
            ...
            <p className="text-[#574F4A] pb-4 leading-relaxed">
              ...
              Previously, I was a{" "}
              <b>UI/UX intern at Activate Interactive</b>, and have had multiple stints as a{" "}
        ...
        <div>
          ...
          <p className="text-[#574F4A] pb-8 leading-relaxed">
            you can probably find me hanging out with a friend, 
            ...
            I also sketch, paint and crochet at times! 
          </p>
